...
from .views import ShortUrlCreateAPIView , ShortUrlUpdatedAPIView,ShortUrlDeleteAPIView,ShortUrlListAPIView,ShortURLRedirectAPIView
...
urlpatterns = [
    ...
    path('<str:short_code>/', ShortURLRedirectAPIView.as_view(), name='short-url-redirect')
